...
function App() {
  ...
  return (
    <div className="App">
      ...
      <Box xs display="flex" justifyContent="center" alignItems="center" sx={{  flexGrow: 1 }}>
      <Grid container spacing={2}>
        <Grid display="flex" justifyContent="center" alignItems="center"  xs={12} md={12}>
          < Header/>
        </Grid>
        <Grid  display="flex" justifyContent="center" alignItems="center" xs={12} md={12}>
    ...
    >
      <Button onClick={() => { setWorkers(sortByName([...workers])) }}>Soet By Name</Button>
      <Button onClick={() => { setWorkers(sortByAge([...workers])) }} >Soet By Age</Button>
    </ButtonGroup>
        </Grid>
        <Grid display="flex" justifyContent="center" alignItems="center"  xs={12} md={12}>
        <List
